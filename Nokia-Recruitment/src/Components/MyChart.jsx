...
export const MyChart= () =>
{
    ...
    useEffect(() => {
       ...
       const continents =apiChartData && apiChartData.map(data=>data.continent);
       const population =apiChartData && apiChartData.map(data=>data.population);
       const tests =apiChartData && apiChartData.map(data=>data.tests);
       console.log(continents)

        const data = {
            labels: ["North America","Asia","Europe","South America","Australia & Ocenia","Africa"],
            datasets: [
                {
                    label: 'Population',
